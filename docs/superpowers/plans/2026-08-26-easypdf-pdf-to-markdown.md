...
- [ ] **Step 3: 实现 4 个 POJO + Markdown 序列化**
...
- [ ] **Step 2: 运行 + Step 3: 实现 PdfStructureExtractor**（详见 easypdf 计划 v2）
...
- [ ] **Step 1: 写失败测试 + Step 2: 实现门面 + Step 3: EasyPdf 扩展 + Step 4: 验证 + Step 5: 全量回归 + Step 6: Commit**

---

### Task 4: 三分支同步 + 推送

- [ ] **Step 1: 3.0.x 全量验证** + **Step 2: 同步 1.0.x** + **Step 3: 验证 1.0.x** + **Step 4: Commit 1.0.x** + **Step 5: 同步 2.0.x** + **Step 6: 验证 2.0.x** + **Step 7: Commit 2.0.x** + **Step 8: 推送 + 计划勾选**
