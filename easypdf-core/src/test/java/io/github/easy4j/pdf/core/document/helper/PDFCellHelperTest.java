...
/**
 * Unit tests for {@link PDFCellHelper}.
 *
 * [@Loong Wan](https://github.com/loong10k)
 */
@DisplayName("PDFCellHelper Tests")
class PDFCellHelperTest {

    @Test
    @DisplayName("static method getInstance should be callable")
    void staticGetInstanceShouldBeCallable() {
        try { PDFCellHelper.getInstance(); } catch (Throwable e) { /* expected */ }
        assertThat(PDFCellHelper.class).isNotNull();
    }
