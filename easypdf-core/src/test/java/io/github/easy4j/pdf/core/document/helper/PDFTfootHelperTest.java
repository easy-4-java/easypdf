...
/**
 * Unit tests for {@link PDFTfootHelper}.
 *
 * [@Loong Wan](https://github.com/loong10k)
 */
@DisplayName("PDFTfootHelper Tests")
class PDFTfootHelperTest {

    @Test
    @DisplayName("static method getInstance should be callable")
    void staticGetInstanceShouldBeCallable() {
        try { PDFTfootHelper.getInstance(); } catch (Throwable e) { /* expected */ }
        assertThat(PDFTfootHelper.class).isNotNull();
    }
